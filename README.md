...
<p></p><br>
 ...
 ## My Projects
  ...
  - [API-E-commerce_Pro_Avanzado_con_Test](https://github.com/Alexdev-01/API-E-commerce_Pro_Avanzado_con_Test). API REST de e-commerce con Spring Boot que implementa autenticación JWT, gestión de productos, categorías y pedidos, control por roles (ADMIN/CLIENTE) y testing completo con JUnit, Mockito y MockMvc.
